...
public class Interface : MonoBehaviour
{
    ...
    {
        instance = this;
        damageTextContainer = new GameObject().transform;
        damageTextContainer.name = "DamageTextContainer";
    }
    ...
    public void SpawnDamageText(Vector3 newPosition, float damage)
    {
        GameObject newDamageText = Instantiate(damageText, damageTextContainer);
        newDamageText.transform.position = newPosition;
        newDamageText.GetComponent<TextMeshPro>().text = damage + "";
    }
}
